                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12">
                        <input type="text" name="title" value="{{ old('title',$setting->title) }}"
                            class="form-control m-input" required="required" placeholder="أدخل عنوان الموقع">
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12">
                        <textarea name="description"
                            class="form-control my-editor">{!! old('description',$setting->description) !!}</textarea>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    <label class="col-form-label col-lg-3 col-sm-12"> كلمات مفتاحية للموقع </label>
                    <div class="col-lg-7 col-md-12 col-sm-12">
                        <input type="text" name="tags" value="{{ old('tags',$setting->tags) }}"
                            class="form-control m-input" required="required" placeholder="أدخل الكلمات المفتاحية ">
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-7 col-md-12 col-sm-12">
                        <input type="text" name="facebook" value="{{ old('facebook',$setting->facebook) }}"
                            class="form-control m-input" required="required" placeholder="https://www.fb.com">
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-7 col-md-12 col-sm-12">
                        <input type="text" name="twitter" value="{{ old('twitter',$setting->twitter) }}"
                            class="form-control m-input" required="required" placeholder="https://www.twitter.com">
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-7 col-md-12 col-sm-12">
                        <input type="text" name="instagram" value="{{ old('instagram',$setting->instagram) }}"
                            class="form-control m-input" required="required" placeholder="https://www.instagram.com">
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    <label class="col-form-label col-lg-3 col-sm-12"> Pintrest Link </label>
                    <div class="col-lg-7 col-md-12 col-sm-12">
                        <input type="text" name="pintrest" value="{{ old('pintrest',$setting->pintrest) }}"
                            class="form-control m-input" required="required" placeholder="https://www.pintrest.com">
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    <label class="col-form-label col-lg-3 col-sm-12"> E-mail </label>
                    <div class="col-lg-7 col-md-12 col-sm-12">
                        <input type="email" name="mail" value="{{ old('mail',$setting->mail) }}"
                            class="form-control m-input" required="required" placeholder="https://www.mail@website.com">
                    </div>
                </div>
