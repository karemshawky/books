		...
		<div class="tpc-content"> <img src="{{ asset('uploads/book/' . $first->pic) }}" class="img-responsive" alt="{{ $first->name }}" />
			<div class="tpc-overlay">
				<div class="tpc-overlay-inner">
					<div class="tpc-info">
					<h4><a href="{{ route('books.slug',$first->slug) }}"> {{ $first->title }} </a></h4> <a href="{{ route('books.slug',$first->slug) }}" class="cart-btn">المزيد</a> </div>
				</div>
			</div>
		</div>
		@endforeach
...
<div class="featured-products featured-products-bottom">
	<div class="container">
		<div class="row">
			<div class="heading-sub heading-sub2 text-center">
				<h5><span> {{ $moreCategory[0]->name }} </span></h5> 
			</div>
			...
			<div class="col-lg-2 col-md-2 col-sm-3 col-xs-6">
				<div class="product-item">
					...
					<div class="product-info">
						<h3 class="product-title"><a href="{{ route('books.slug',$arabic->slug) }}"> {{ $arabic->title }} </a></h3>
					</div>
				</div>
			</div>
			@endforeach
	...
	<div class="text-center"> <a class="btn-color show-more" href="{{ route('cat', $moreCategory[0]->slug ) }}">عرض المزيد</a> </div>
...
<div class="product-widgets">
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<h5 class="heading2 space40"><span> {{ $moreCategory[1]->name }}  </span></h5>
				<div class="product-carousel">
					...
					<div class="pc-wrap col-md-3 col-sm-3 col-xs-3">
						<div class="product-item">
							...
							<div class="product-info">
									<h3 class="product-title"><a href="{{ route('books.slug',$history->slug) }}"> {{ $history->title }} </a></h3>
							</div>
						</div>
					</div>
					@endforeach
				</div>
				<div class="text-center"> <a class="btn-color show-more" href="{{ route('cat', $moreCategory[1]->slug) }}">عرض المزيد</a> </div>
			</div>
			<div class="col-md-6">
				<h5 class="heading2 space40"><span> {{ $moreCategory[2]->name }}  </span></h5>
				<div class="product-carousel2">
					...
					<div class="pc-wrap col-md-3 col-sm-3 col-xs-3">
						<div class="product-item">
							...
							<div class="product-info">
									<h3 class="product-title"><a href="{{ route('books.slug',$human->slug) }}"> {{ $human->title }} </a></h3>
							</div>
						</div>
					</div>
					@endforeach
				</div>
				<div class="text-center"> <a class="btn-color show-more" href="{{ route('cat', $moreCategory[2]->slug ) }}">عرض المزيد</a> </div>
			</div>
		</div>
	</div>
</div>
...
<div class="featured-products featured-products-top">
	<div class="container">
		<div class="row">
			<div class="heading-sub heading-sub2 text-center">
				<h5><span> {{ $moreCategory[3]->name }}   </span></h5>
			</div>
			...
			<div class="col-lg-2 col-md-2 col-sm-3 col-xs-6">
				<div class="product-item">
					...
					<div class="product-info">
						<h3 class="product-title"><a href="{{ route('books.slug',$translated->slug) }}"> {{ $translated->title }} </a></h3>
					</div>
				</div>
			</div>
			@endforeach
	...
	<div class="text-center"> <a class="btn-color show-more" href="{{ route('cat', $moreCategory[3]->slug ) }}">عرض المزيد</a> </div>
	<div class="space10"></div>
</div>
<div class="space20"></div>
@endsection